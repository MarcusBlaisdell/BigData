...
void printList (list <theViewsStruct> viewsList, int K)
{
  int i = 0, j = 0;
  ...
  cout << "top " << K << "popular (by view count):" << endl;
...
int main(void)
{
  ...
  outFile.open ("topK_rates-dynamic_3.txt", ios::out);
  timeFile.open ("topK_rates-dynamic_3_times.txt");
